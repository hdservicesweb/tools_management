...
?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3">
                <a href='#' id='forward_wo' class='btn btn-success btn-sm' data-toggle='modal' data-target='#move_wo' onclick='update_wo(this.id)'>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <i class="fa fa-inbox" style="color:green;font-size:40px"></i>
                            </div>
                            <div class="col-6">
                                <i class="fa fa-arrow-right" style="color:green;font-size:40px"></i>
                            </div>
                        </div>
                        <br>
                ...
                <div class="card text-center">
                    <div class="card-header">
                        <nav class="nav nav-tabs card-header-tabs" id="nav-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Last Movements</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">General Instructions</a>
                        ...
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            ...
                            <div name="lastmovements" id="lastmovements">
                                <table class="table table-striped table-bordered table-hover table-condensed table-sm" width="100%">
                                    <?php
                                    $sqlquery = "SELECT * from wo order by wo.last_movement desc, wo.due_date asc limit 12";
    ...
    <div class='container-fluid'>
        ...
        <h5>
            <?= $searchingfor ?> <input type="text" value="<?= $search ?>" id="lastsrch" style="border: none; background: transparent;" readonly>
        </h5>
        <p>
            <?= $records ?>
        </p>
