...
<?php
    ...
    <div class='container-fluid'>
        ...
        <p>
            ...
            <a href="new_tool.php" id="new" ><i class="fa fa-plus"></i></a> 
        </p>
                    ...
                    <?php
                          ...
                          if (mysqli_num_rows($result2) > 0) {
                            ...
                            while ($rowcommon = mysqli_fetch_array($result2)) {
                                echo "<br><a href='index.php?srch=".$rowcommon['tool_pn']."'>".$rowcommon['component_pn']."</a>";
                            }
...
<script>
    function update_modal(id) {
        ...
        if (pcs_id == "getting") {
            ...
            document.getElementById("psc_id").focus();
        } else {
    ...
    // function research() {
    //     status = document.getElementById("common").checked;
    //     if (status == "true") {
    //         document.getElementById("research_b").removeAttribute("hidden");
    //         document.getElementById("common_main").checked = true;

    //         document.getElementById("srch").value = document.getElementById("lastsrch").value;
    //     } else {
    //         document.getElementById("common_main").checked = false;
    //         document.getElementById("research_b").setAttribute("hidden", "true");
    //     }
